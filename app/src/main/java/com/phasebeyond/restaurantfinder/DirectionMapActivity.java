...
public class DirectionMapActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //Place a marker at the desired restaurant
        mMap.addMarker(new MarkerOptions().position(destLatLng).title(restaurant_name));

        Button showRouteButton = (Button) findViewById(R.id.showRouteButton);
        showRouteButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                originLatLng = new LatLng(mLastLocation.getLatitude(), mLastLocation.getLongitude());

                mMap.addMarker(new MarkerOptions().position(originLatLng).title("Current Location"));
                mMap.addMarker(new MarkerOptions().position(destLatLng).title(restaurant_name));
